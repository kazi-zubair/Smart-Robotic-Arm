function varargout = dataCreator(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @dataCreator_OpeningFcn, ...
                   'gui_OutputFcn',  @dataCreator_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function dataCreator_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = dataCreator_OutputFcn(hObject, eventdata, handles) 
...
handles.x=x;
handles.y=y;
handles.data=ones(40);
handles.croped=ones(40);
